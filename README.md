...
- Paginación y ordenación avanzada en listados.
- Gestión de múltiples préstamos por socio (historial).
- Búsqueda avanzada por autor/categoría/año.
- Tests automáticos (pytest).
- Migraciones (Flask-Migrate) en lugar de create_all().
